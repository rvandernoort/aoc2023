...
with open('input.txt') as f:
    ...
    for row in content.splitlines():
        ...
        for char in hand:
            if char == 'J' and hand != "JJJJJ":
                continue
            cards[char] += 1
        
        for card_count in sorted(cards.values(), reverse=True):
            if hand == "JAJ4A":
                    print(f"{card_count}, {hand.count('J')}")
            if hands[hand] == 0 and (card_count == 5 - hand.count('J') or hand.count('J') == 5 or hand.count('J') == 4):
                hands[hand] = 6
            elif hands[hand] == 0 and (card_count == 4 - hand.count('J') or hand.count('J') == 3):
                hands[hand] = 5
            elif hands[hand] == 1 and card_count == 3 or hands[hand] == 3 and card_count == 2:
                hands[hand] = 4
            elif hands[hand] == 0 and (card_count == 3 - hand.count('J') or hand.count('J') == 2):
                hands[hand] = 3
            elif hands[hand] == 1 and card_count == 2:
                hands[hand] = 2
            elif hands[hand] == 0 and (card_count == 2 - hand.count('J') or hand.count('J') == 1):
                hands[hand] = 1
    ...
    # wrong: 250771536 too high
    # wrong: 250597917 too high
    # wrong: 251291763 too high
    # wrong: 247989376 too low
    # wrong: 249166141 ?
    # wrong: 249602016
    # wrong: 249163028
    # wrong: 249400220
